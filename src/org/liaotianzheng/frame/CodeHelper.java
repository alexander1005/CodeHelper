...
import static org.liaotianzheng.frame.Configuration.getBeanTemplateLocation;
import static org.liaotianzheng.frame.Configuration.getDaoTemplateLocation;
import static org.liaotianzheng.frame.Configuration.getMybatisTemplateLocation;
import static org.liaotianzheng.frame.Configuration.getServiceImplTemplateLocation;
import static org.liaotianzheng.frame.Configuration.getServiceTemplateLocation;
import static org.liaotianzheng.frame.Configuration.getUseLombok;
import static org.liaotianzheng.frame.Configuration.setCodeTemplateType;
import static org.liaotianzheng.frame.Configuration.setUseLombok;
...
public class CodeHelper {
    ...
    private void createCode() throws Exception {
        ...
        if (!columns.isEmpty()) {
            ...
            String serviceCode = getServiceCode(table, packages, author, columns);
            serviceText.setText(serviceCode);
            String serviceImplCode = getServiceImplCode(table, packages, author, columns);
            serviceImplText.setText(serviceImplCode);
            String daoCode = getDaoCode(table, packages, author, columns);
    ...
    private String getMyBatisCode(Table table, String pack, String author, List<Column> columns) throws Exception {
        ...
        for (int i = 0; i < columns.size(); i++) {
            ...
            if (c.IsPrikey()) {
                ...
                id_type = id_type != "" ? id_type : c.getMybatisFieldType();
            } else {
     ...
     * @author ltz
     */
    private String getServiceCode(Table table, String pack, String author, List<Column> columns) throws Exception {
        ...
        classMap.put("class.name", className);
        classMap.put("class.package", pack);
        classMap.put("param.id_type", id_type);
        classMap.put("now", Util.format(new Date()));
        classMap.put("author", author);
        for (Map.Entry<String, String> entry : classMap.entrySet()) {
     ...
     * @author ltz
     */
    private String getDaoCode(Table table, String pack, String author, List<Column> columns) throws Exception {
     ...
     * @author ltz
     */
    private String getServiceImplCode(Table table, String pack, String author, List<Column> columns) throws Exception {
